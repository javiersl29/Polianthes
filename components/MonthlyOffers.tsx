          ...
          {total > 1 && (
            <>
              <button
                ...
                onClick={() => go(-1)}
                aria-label="Anterior"
                className="absolute left-1 sm:-left-6 top-1/2 -translate-y-1/2 z-30 w-11 h-11 rounded-full bg-bg-elev/95 backdrop-blur-md border border-white/10 grid place-items-center text-ink hover:text-gold hover:border-gold/50 hover:scale-110 active:scale-95 transition-all shadow-xl"
              >
              ...
              <button
                ...
                className="absolute right-1 sm:-right-6 top-1/2 -translate-y-1/2 z-30 w-11 h-11 rounded-full bg-bg-elev/95 backdrop-blur-md border border-white/10 grid place-items-center text-ink hover:text-gold hover:border-gold/50 hover:scale-110 active:scale-95 transition-all shadow-xl"
              >
