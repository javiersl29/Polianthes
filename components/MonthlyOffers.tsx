          ...
          {total > 1 && (
            <>
              <button
                ...
                onClick={() => go(-1)}
                aria-label="Anterior"
                className="absolute left-0 top-[30%] -translate-y-1/2 z-20 w-10 h-10 rounded-full liquid-glass-strong grid place-items-center text-ink hover:text-gold transition-colors"
              >
              ...
              <button
                ...
                className="absolute right-0 top-[30%] -translate-y-1/2 z-20 w-10 h-10 rounded-full liquid-glass-strong grid place-items-center text-ink hover:text-gold transition-colors"
              >
